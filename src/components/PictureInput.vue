    ...
    <div v-else-if="supportsPreview">
      <div class="preview-container"
        ...
        <canvas ref="previewCanvas"
                ...
                :style="{height: previewHeight + 'px','z-index':11}">
        </canvas>
        <div class="picture-inner"
             :style="{'z-index':10,top: -previewHeight-15 + 'px', marginBottom: -previewHeight + 'px', fontSize: fontSize, borderRadius: radius + '%'}">
          <i data-v-ea345466="" class="el-icon-plus avatar-uploader-icon"></i>
